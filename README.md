...
- Note: If you're on Linux and have Git installed, you can configure the *Pre-launch Command* under *Settings* for the instance to use **"main.sh"**. However, running the .py file using Python should also work the same.
